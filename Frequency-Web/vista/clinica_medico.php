...
<body>
  ...
  <div class="container">
	...
	<table class="table table-striped">
		...
		<tbody>
		<?php foreach(Obtener_Medico_Clinica($_SESSION['id']) AS $Medico){ ?>
			<tr>	
          ...
          <div class="row">
            <div id="div_ruta_img_medico" class="form-group col-xs-12 col-sm-4">
              ...
              <div id="div_codigo_medico" class="form-group col-xs-12 col-sm-8">
                  <label class="control-label"> Codigo Clinica: </label>       
                  <input Disabled type="text" class="form-control" id="codigo_medico" value=<?php echo  $_SESSION['id']; ?>>
              </div>
            </div>
              <div class="row">
